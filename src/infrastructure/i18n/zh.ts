...
export const zh: Catalogue = {
  ...
  'timeline.locked': '正在准备项目。准备完成后时间线才可编辑。',
  ...
  'export.mode.fast.summary': '几秒钟。切点精确，画质不变。',
  'export.mode.fast.detail':
    '视频直接复制而不是重新编码，所以速度只受磁盘限制，画质保持原样。只有每个切点旁边的几帧会重新编码，因此每个切点都落在你选定的那一帧上。',
  ...
  'export.lossless.partial': '切点精确。切点旁约 {time} 会重新编码，其余部分原样复制。',
  ...
  'panels.label': '面板',
  'panels.hideColumn': '隐藏面板',
  'panels.showColumn': '显示面板',
  'panels.collapse': '收起',
  'panels.expand': '展开',
  'panels.hide': '隐藏此面板',
