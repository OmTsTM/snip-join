...
export const es: Catalogue = {
  ...
  'media.empty': 'Aquí no hay nada todavía. Añade un vídeo o una imagen para empezar la edición.',
  ...
  'hint.clearSelection': 'Suelta los raíles sin quitar nada · Esc',
  'hint.markIn': 'Pone el inicio de la selección en el cursor · I',
  'hint.markOut': 'Pone el final de la selección en el cursor · O',
  'hint.remove': 'Quita el tramo marcado de la línea de tiempo · Delete',
  'hint.chooseVideo': 'Elige un vídeo o una imagen para abrir · Ctrl O',
  'hint.destination': 'Elige dónde va el archivo exportado',
  'hint.startExport': 'Escribe el archivo con las opciones de arriba',
  ...
  'hint.updateNotes': 'Abre la página de versiones en el navegador',
  'hint.updateClose': 'Cierra esto. No se descarga ni se instala nada.',
  'hint.updateDownload': 'Descarga y comprueba su firma',
  'hint.updateWait': 'Descargando. Tarda un momento.',
  ...
  'update.upToDate': 'Snip Join {version} es la versión más reciente.',
  'update.available': 'Snip Join {version} ya está disponible.',
