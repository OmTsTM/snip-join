...
export const en = {
  ...
  'media.missing': 'This file is not where the project left it',
  'media.locate': 'Find it…',
  ...
  'hint.clearSelection': 'Drop the rails without removing anything · Esc',
  'hint.markIn': 'Put the start of the selection at the playhead · I',
  'hint.markOut': 'Put the end of the selection at the playhead · O',
  'hint.remove': 'Take the marked stretch out of the timeline · Delete',
  'hint.chooseVideo': 'Pick a video or an image to open · Ctrl O',
  'hint.destination': 'Pick where the exported file goes',
  'hint.startExport': 'Write the file with the settings above',
  ...
  'hint.updateNotes': 'Open the releases page in your browser',
  'hint.updateClose': 'Close this. Nothing is downloaded or installed.',
  'hint.updateDownload': 'Fetch it and check its signature',
  'hint.updateWait': 'Fetching it. This takes a moment.',
  ...
  'update.upToDate': 'Snip Join {version} is the newest there is.',
  'update.available': 'Snip Join {version} is out.',
